...
echo"<META HTTP-EQUIV='REFRESH' CONTENT='0; URL=$pageurl?page=$page&message=Certificate deletd..'>";  exit(0);
...
if (!mysqli_query($con,$sql)) {die('Error: ' . mysqli_error()); }
echo"<META HTTP-EQUIV='REFRESH' CONTENT='0; URL=$pageurl?page=$page&message=Certificate updated..'>";  exit(0);
...
<table width="100%" border="0">
  <tr>
    <td><a onClick="popupCenter('addreview<?php echo $extn ?>', 'myPop1',550,550);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><span class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i> ADD NEW REVIEW</span></a></td>
...
?>			 
	...
	<?php if ($total_pages>="1"){?> 
		<form name="delete" id="frmCompare" class="frmCompare" action="<?php echo $pageurl ?>?page=<?php echo $page ?>" method="post"> 
...
while ($row = mysqli_fetch_array($result)) {
    if (!empty($row['review'])) { // Check if 'review' is not empty or null
        ...
        ?><a onClick="popupCenter('addreview<?php echo $extn ?>?id=<?php echo $row['sessionid'] ?>', 'myPop1',550,600);" href="javascript:void(0);" style="text-decoration:none;color:#00F; cursor:pointer;"><img src='images/edit.png' title='Edit'></a><?php
        echo "</td>";
