...
<?php include 'check.php'; $pageurl="webquery"; $tbl_name="dg_query"; $pagename="Website Query"; $mintablewidth="1000px";
...
<div style='overflow-x: auto;'> 
	...
	*/
    ...
    if(count($conditions) > 0) {
		...
		$sqlx .= " and ". implode (' and ', $conditions); // you can change to 'HeOR', but I suggest to apply the filters cumulative
    }
